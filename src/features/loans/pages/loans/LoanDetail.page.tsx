...
import { useLoanDetail } from '../../hooks/loans/useLoans.hook';
...
export function LoanDetailPage({ id: propId }: LoanDetailPageProps = {}) {
    ...
    <>
      <FormStackScreen title={loan.name} eyebrow={loan.type.replace(/_/g, ' ')} subtitle={loan.closed ? 'Paid off' : `${pct}% paid off`} onBack={goBack}>
        ...
        <DetailActions
          ...
          onPrimary={() => { if (!loan.closed) router.push(`/loans/${id}/pay`); }}
          secondaryTitle="Edit"
