...
import { useOnboarding, useSignOut } from '@/features/auth';
...
import { onboardingStyles } from '../../styles/onboarding/onboarding.styles';
...
export function OnboardingPage() {
  ...
  return (
    <StackScrollScreen header={<StackNavHeader title="Onboarding" subtitle="Tell us about yourself" showBack={false} />}>
      <form onSubmit={handleSubmit} className={onboardingStyles.form} style={{ gap: theme.spacing.lg }}>
        <Input
          label="Full Name"
