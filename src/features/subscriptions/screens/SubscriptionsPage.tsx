    ...
    <StickyHeaderFlatScreen
      ...
      ListEmptyComponent={
        isLoading ? (
          ...
          <EmptyState title="No recurring bills yet" subtitle="Mark an expense as recurring and it'll show up here, or add one manually" icon="calendar" action="Add subscription" onAction={() => navigate('/subscriptions/add')} />
        )
      }
    />
  );
