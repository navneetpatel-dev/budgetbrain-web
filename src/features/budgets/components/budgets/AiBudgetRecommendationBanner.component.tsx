...
import { aiBudgetRecommendationStyles } from '../../styles/budgets/aiBudgetRecommendation.styles';
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div className={aiBudgetRecommendationStyles.titleRow}>
          <span
            style={{
        ...
        <div className={aiBudgetRecommendationStyles.actions}>
          <button
            type="button"
