...
import { Card, Button, Input, FormErrorBanner } from '@/shared/components/ui/index';
...
export function ReportsPage() {
  ...
  return (
    <ScreenWrapper header={<ProfileStackHeader screen="reports" subtitle="Export your data" />} inset="stack">
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <div>
            ...
            <span style={{
              ...
              Download CSV, Excel, or PDF for any date range
            </span>
          </div>
        </div>
        ...
        <div style={{ position: 'relative', marginTop: 20 }}>
          <Button
            ...
            onPress={() => router.push('/reports/recap')}
            variant="outline"
            icon="sparkles"
            size="lg"
          />
      ...
      {/* Date Range Card */}
      <Card variant="elevated" style={{ display: 'flex', flexDirection: 'column', gap: theme.spacing.sm, marginBottom: theme.spacing.lg }}>
